...
source=("$pkgname-0.5.6.tar.gz::$url/archive/v0.5.6.tar.gz")
sha256sums=("56f87e5e6cf91fbc8079d3d0ac082c54b77f4fa1bbbd576161de2e7f9832055a")  # Will be updated by release manager
